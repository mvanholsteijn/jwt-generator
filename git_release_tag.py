...
class GitReleaseTagger:
	...
	def __init__(self, with_branch_info=True):
		self.path = None
		self.release = None
		self.tag = None
		self.errors = []
		self.dry_run = False
		self.with_branch_info = with_branch_info
	...
	def get_current_release(self):
		...
		if self.with_branch_info and self.current_release != self.release and self.branch != 'master':
	...
	def main(self):
		...
		parser.add_argument("--with-branch-info", action="store_true", dest="with_branch_info",
				    help="show the branch name in the release tag")
		...
		self.with_branch_info = options.with_branch_info 
